...
def attack_success(
    x, img, target_calss, net, targeted_attack=False, print_log=False, device="cuda"
):
    ...
    if (targeted_attack and pred == target_calss) or (
        not targeted_attack and pred != target_calss
    ):
        return True
