...
cmd_opt.add_argument(
    "-latent_dim", type=int, default=64, help="dimension of latent layers"
)
cmd_opt.add_argument("-hidden", type=int, default=0, help="dimension of classification")
cmd_opt.add_argument(
    "-max_lv", type=int, default=1, help="max rounds of message passing"
)

# target model
cmd_opt.add_argument("-num_epochs", type=int, default=200, help="number of epochs")
cmd_opt.add_argument(
    "-learning_rate", type=float, default=0.01, help="init learning_rate"
)
...
cmd_opt.add_argument(
    "-num_mod", type=int, default=1, help="number of modifications allowed"
)
