...
parser.add_argument(
    "--attack", type=str, default="meta", choices=["no", "meta", "random", "nettack"]
)
...
parser.add_argument(
    "--lambda_", type=float, default=0, help="weight of feature smoothing"
)
parser.add_argument("--phi", type=float, default=0, help="weight of symmetric loss")
parser.add_argument(
    "--inner_steps", type=int, default=2, help="steps for inner optimization"
)
parser.add_argument(
    "--outer_steps", type=int, default=1, help="steps for outer optimization"
)
...
perturbed_adj, features, labels = preprocess(
    perturbed_adj, features, labels, preprocess_adj=False, device=device
)
