...
def load_data(args):
    ...
    if 'collab' in dataset:
        from ..data_configs.collab import (testlength,vallength,length,processed_datafile_ori,processed_datafile_eva,processed_datafile_poi)
        ...
        from ..data_configs.yelp import (testlength,vallength,length,shift,num_nodes,processed_datafile_ori,processed_datafile_eva,processed_datafile_poi)
        args.dataset = dataset
        args.testlength = testlength
        args.vallength = vallength
        args.length = length
        ...
        from ..data_configs.act import (testlength,vallength,length,processed_datafile_ori,processed_datafile_eva,processed_datafile_poi)
        args.dataset = dataset
        args.testlength = testlength
        args.vallength = vallength
        args.length = length
